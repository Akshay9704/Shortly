    ...
    <>
      <header className="Header max-width py-5">
        <div className="flex items-center justify-between">
          <article className="flex items-center">
            ...
            <nav className="hidden md:block md:ml-5">
              <ul className="flex items-start justify-start">
                ...
                <li>
                  <button className="text-slate-400 my-5 md:my-0 md:mx-5">
                    Pricing
                  </button>
                </li>
                <li>
          ...
          {isOpen && (
            <div className="absolute left-5 right-5 top-20 text-center py-10 rounded bg-slate-900 text-slate-200 md:relative md:top-0 md:left-0 md:right-0 md:bg-transparent md:text-slate-700 md:text-left md:py-0 md:flex md:items-center">
              <nav className="md:hidden">
                <ul className="flex flex-col items-center justify-center">
                  ...
                  <li>
                    <button className="my-5">Pricing</button>
                  </li>
                  <li>
